...
public class AdapterAdminWork extends RecyclerView.Adapter<AdapterAdminWork.MyHolder>{
    final Context context;
    final List<ModelWork> userList;

    public AdapterAdminWork(Context context, List<ModelWork> userList) {
            ...
            public boolean onLongClick(View v) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (id == 1){
                            deletePost(pId);
                            FirebaseDatabase.getInstance().getReference().child("WorkReport").child(pId).addValueEventListener(new ValueEventListener() {
                                @Override
