...
public class AdapterArticleReplyComments extends RecyclerView.Adapter<AdapterArticleReplyComments.MyHolder> implements View.OnClickListener {
    ...
    public AdapterArticleReplyComments(Context context, List<ModelComments> commentsList) {
        ...
        likeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(postKey).hasChild(userId)){
                    ...
                    holder.image.setImageResource(R.drawable.icon_fav_lightgrey);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
