...
public class AdapterSaveChat extends RecyclerView.Adapter<AdapterSaveChat.MyHolder> {
    ...
    public AdapterSaveChat(Context context, ArrayList<ModelGroupChat> modelGroupChats) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.messageLayout.setOnLongClickListener(v -> {
            ...
            args.putString("id", modelGroupChats.get(position).getSender());
            args.putString("chatId", modelGroupChats.get(position).getTimestamp());
            args.putString("content", "save");
