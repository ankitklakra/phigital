...
public class AdapterUsersTag extends RecyclerView.Adapter<AdapterUsersTag.MyHolder>{

    final Context context;
    final List<ModelUser> userList;

    public AdapterUsersTag(Context context, List<ModelUser> userList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            intent.putExtra("item", userUsernsme);
