...
public class AdapterArticleComments2 extends RecyclerView.Adapter<AdapterArticleComments2.MyHolder> implements View.OnClickListener {
    ...
    public AdapterArticleComments2(Context context, List<ModelComments> commentsList) {
...
//        postsRef2.addValueEventListener(new ValueEventListener() {
//            @Override
...
//                    loadreplies(holder,position,cId);
//                }
//            }
//            @Override
...
//        SocialTextView socialTextView = holder.mComment;
//        final String string11 = comment;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (mProcessLike){
                            if (dataSnapshot.child(postId).hasChild(userId)){
                                ...
                                likeRef.child(postId).child(userId).setValue("Liked");
                                mProcessLike = false;
                                addToHisNotification(""+id,""+pId,"Liked your comment");
                            }
                        }
                    }
...
//        });
    ...
    private void addToHisNotification(String hisId, String pId, String notification){
        ...
        String image =  PostComments.getmeme();
