...
public class AdapterCustomerUser extends RecyclerView.Adapter<AdapterCustomerUser.MyHolder>{

    final Context context;
    final List<ModelCustomerOrder> userList;

    public AdapterCustomerUser(Context context, List<ModelCustomerOrder> userList) {
