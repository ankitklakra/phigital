...
public class AdapterProductCart extends RecyclerView.Adapter<AdapterProductCart.MyHolder> {

    Context context;
    final List<ModelCart> productList;
    private final DatabaseReference databaseReference;
    private String userId,num,finalmrp,finalsave;

    public AdapterProductCart(Context context, List<ModelCart> productList) {
