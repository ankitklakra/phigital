...
import com.phigital.ai.Shop.ShippingOrderView;
...
public class AdapterShippingUser extends RecyclerView.Adapter<AdapterShippingUser.MyHolder>{

    final Context context;
    final List<ModelCustomerOrder> userList;

    public AdapterShippingUser(Context context, List<ModelCustomerOrder> userList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, ShippingOrderView.class);
