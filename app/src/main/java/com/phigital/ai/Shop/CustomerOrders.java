...
import com.phigital.ai.Adapter.AdapterCustomerUser;
...
public class CustomerOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapters = new AdapterCustomerUser(CustomerOrders.this,userList);
        binding.cartView.setHasFixedSize(true);
        binding.cartView.setLayoutManager(new LinearLayoutManager(CustomerOrders.this,LinearLayoutManager.VERTICAL, false));
