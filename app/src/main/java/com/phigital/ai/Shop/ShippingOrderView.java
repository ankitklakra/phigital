...
public class ShippingOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapters = new AdapterOrderProductCart(ShippingOrderView.this,productList);
        binding.cartView.setHasFixedSize(true);
        binding.cartView.setLayoutManager(new LinearLayoutManager(ShippingOrderView.this,LinearLayoutManager.VERTICAL, false));
        binding.cartView.setAdapter(adapters);

        binding.done.setText("Track Orders");
        ...
        DatabaseReference dREF = FirebaseDatabase.getInstance().getReference().child("ShippingOrders").child(hisOrderid);
    ...
    private void loadPost(String hisOrderid) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("ShippingOrders").child(hisOrderid).child("Order");
