...
public class CustomerOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapters = new AdapterOrderProductCart(CustomerOrderView.this,productList);
        binding.cartView.setHasFixedSize(true);
        binding.cartView.setLayoutManager(new LinearLayoutManager(CustomerOrderView.this,LinearLayoutManager.VERTICAL, false));
        ...
        DatabaseReference dREF = FirebaseDatabase.getInstance().getReference().child("CustomerOrders").child(hisOrderid);
        ...
        binding.done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatabaseReference invoicenode = FirebaseDatabase.getInstance().getReference().child("Invoice").child(hisOrderid);
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        cartNodes.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NotNull DataSnapshot dataSnapshot){
                                invoicenode.setValue(dataSnapshot.getValue()).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(@NonNull @NotNull Void unused) {
                                        ...
                                        hashMap.put("invoicedate", date);
                                        invoicenode.updateChildren(hashMap);
                                    }
                                });
                ...
                Snackbar.make(binding.view,"Uploaded", Snackbar.LENGTH_LONG).show();
