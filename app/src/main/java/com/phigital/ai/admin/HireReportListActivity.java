...
import com.phigital.ai.Adapter.AdapterAdminHire;
...
public class HireReportListActivity extends BaseActivity {

    RecyclerView trendingRv;

    //Post
    AdapterAdminHire adapterPost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterPost = new AdapterAdminHire(this, postList);
    ...
    private void mySaved() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("HireReport");
    ...
    private void readSave() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                postList.clear();
                for (DataSnapshot snapshot1 : snapshot.getChildren()){
                    ModelHire post = snapshot1.getValue(ModelHire.class);
