...
import com.phigital.ai.Adapter.AdapterAdminArticle;
...
public class ArticleReportListActivity extends BaseActivity {

    RecyclerView trendingRv;

    //Post
    AdapterAdminArticle adapterPost;
    ...
    private void mySaved() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ArticleReport");
    ...
    private void readSave() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                postList.clear();
                for (DataSnapshot snapshot1 : snapshot.getChildren()){
                    ModelArticle post = snapshot1.getValue(ModelArticle.class);
