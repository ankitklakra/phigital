...
import com.phigital.ai.Adapter.AdapterAdminPoll;
...
public class PollReportListActivity extends BaseActivity {

    RecyclerView trendingRv;

    //Post
    AdapterAdminPoll adapterPost;
    List<ModelPoll> postList;
    List<String> mySaves;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterPost = new AdapterAdminPoll(this, postList);
    ...
    private void mySaved() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("PollReport");
    ...
    private void readSave() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                postList.clear();
                for (DataSnapshot snapshot1 : snapshot.getChildren()){
                    ModelPoll post = snapshot1.getValue(ModelPoll.class);
