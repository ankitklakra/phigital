...
import com.phigital.ai.databinding.ActivityWorkBinding;
...
public class WorkActivity extends BaseActivity {
        ...
        binding.applynow.setOnClickListener(v -> {
            ...
            if (pdfuri == null){
               ...
               binding.pb.setVisibility(View.VISIBLE);
                ...
                uploadwithcv(mjobtype,medu,mexpert,mcity,msalary,mwage,mexperiencenum,mexperiencetime,memail,maddress,mdescription);
                binding.pb.setVisibility(View.VISIBLE);
            }
        });
    ...
    private void uploadwithcv(String mjobtype, String medu, String mexpert, String mcity, String msalary, String mwage, String mexperiencenum, String mexperiencetime, String memail, String maddress, String mdescription) {
        String timeStamp = String.valueOf(System.currentTimeMillis());
        String filePathAndName = "FindJob/" + "FindJob_" + timeStamp;
        ...
        ref.putFile(pdfuri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    if (uriTask.isSuccessful()) {
                        ...
                        DatabaseReference dRef = FirebaseDatabase.getInstance().getReference("Work");
    ...
    private void uploadwithoutcv(String mjobtype, String medu, String mexpert, String mcity, String msalary, String mwage, String mexperiencenum, String mexperiencetime, String memail, String maddress, String mdescription) {
        String timeStamp = String.valueOf(System.currentTimeMillis());
        HashMap<Object, String> hashMap = new HashMap<>();
        hashMap.put("id", id);
        hashMap.put("name", name);
