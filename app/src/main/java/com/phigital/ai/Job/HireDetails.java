...
import com.phigital.ai.databinding.ActivityJobdetailsBinding;
...
public class HireDetails extends BaseActivity implements View.OnClickListener{
    ...
    String hisId, hisName, pid, hisJobtype, hisDp, hisEducation, hisExpert, hisTime, hisCity,
            ...
            hisEmail,hisAddress,hisCv,hisBusiness,hisHire;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_jobdetails);
        ...
        binding.businessname.setShowSoftInputOnFocus(false);
        binding.hire.setShowSoftInputOnFocus(false);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    hisBusiness = ""+ds.child("business").getValue();
                    hisHire = ""+ds.child("hire").getValue();
...
//                    catch (Exception ignored){}
                    ...
                    binding.businessname.setText(hisBusiness);
                    binding.hire.setText(hisHire);
    ...
    private void downloadpdf() {
        ...
        picRef.getDownloadUrl().addOnSuccessListener(uri -> {
            ...
            downloadFile(HireDetails.this, "Hire", ".pdf", DIRECTORY_DOWNLOADS, url);
...
//    }
    ...
    private void loadPostInfo() {
        if (DeleteBottomSheet == null) {
            @SuppressLint("InflateParams") View view = LayoutInflater.from(HireDetails.this).inflate(R.layout.delete_bottom_sheet, null);
            delete = view.findViewById(R.id.delete);
            reportCL = view.findViewById(R.id.reportCL);
            delete.setOnClickListener(this);
            reportCL.setOnClickListener(this);

            DeleteBottomSheet = new BottomSheetDialog(HireDetails.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.reportCL:
                DeleteBottomSheet.cancel();
                AlertDialog.Builder builder = new AlertDialog.Builder(HireDetails.this);
                builder.setTitle("Report");
                builder.setMessage("Are you sure to report this work?");
                builder.setPositiveButton("Report",(dialog, which) -> {
                    FirebaseDatabase.getInstance().getReference().child("HireReport").child(pid).setValue(true);
                    Toast.makeText(HireDetails.this, "Hire Reported...", Toast.LENGTH_SHORT).show();
    ...
    private void deletecontent() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Intent intent = new Intent(HireDetails.this, MainActivity.class);
